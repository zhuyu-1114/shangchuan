...
public class Provider {
    ...
    public Provider(int id, String proCode, String proName, String proDesc, String proContact, String proPhone, String proAddress, String proFax, Date modifyDate, int modifyBy) {
        this.id = id;
        this.proCode = proCode;
        this.proName = proName;
        this.proDesc = proDesc;
    ...
    public Provider(String proCode, String proName, String proDesc, String proContact, String proPhone, String proAddress, String proFax, int createdBy, Date creationDate) {
        this.proCode = proCode;
        this.proName = proName;
        this.proDesc = proDesc;
        this.proContact = proContact;
